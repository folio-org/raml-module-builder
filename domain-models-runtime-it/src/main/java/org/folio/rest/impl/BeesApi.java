...
public class BeesApi implements org.folio.rest.jaxrs.resource.Bees {
  ...
  @Override
  public void getBeesBees(String query, int offset, int limit, String lang, Map<String, String> okapiHeaders,
      Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
    PgUtil.get(TABLE, Bee.class, Bees.class, query, offset, limit, okapiHeaders, vertxContext,
        GetBeesBeesResponse.class, asyncResultHandler);
  }

  @Override
  public void postBeesBees(String lang, Bee entity, Map<String, String> okapiHeaders,
      Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  public void getBeesBeesByBeeId(String id, String lang, Map<String, String> okapiHeaders,
      Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  public void deleteBeesBeesByBeeId(String id, String lang, Map<String, String> okapiHeaders,
      Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  public void putBeesBeesByBeeId(String id, String lang, Bee entity, Map<String, String> okapiHeaders,
      Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
  ...
  @Override
  public void getBeesHistory(int offset, int limit, String query, String lang, Map<String, String> okapiHeaders,
      Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
