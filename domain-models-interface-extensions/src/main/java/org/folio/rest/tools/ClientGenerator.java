...
public class ClientGenerator {
  ...
  public void generateClassMeta(String className, Object globalPath) {
    ...
    try {
      ...
      JMethod constructor = constructor(JMod.PUBLIC);
      JVar host = constructor.param(String.class, "host");
      JVar port = constructor.param(int.class, "port");
      JVar param = constructor.param(String.class, TENANT_ID);
      ...
      JMethod constructor2 = constructor(JMod.PUBLIC);
      JVar hostVar = constructor2.param(String.class, "host");
      JVar portVar = constructor2.param(int.class, "port");
      JVar tenantIdVar = constructor2.param(String.class, TENANT_ID);
      JVar tokenVar = constructor2.param(String.class, TOKEN);
      JBlock conBody2 = constructor2.body();
      ...
      JMethod constructor1 = constructor(JMod.PUBLIC);
      JVar hostVar1 = constructor1.param(String.class, "host");
      JVar portVar1 = constructor1.param(int.class, "port");
      JVar tenantIdVar1 = constructor1.param(String.class, TENANT_ID);
      JVar tokenVar1 = constructor1.param(String.class, TOKEN);
      JVar keepAlive1 = constructor1.param(boolean.class, "keepAlive");
      JBlock conBody1 = constructor1.body();
      conBody1.invoke("this").arg(hostVar1).arg(portVar1).arg(tenantIdVar1).arg(tokenVar1).arg(keepAlive1)
        .arg(JExpr.lit(2000)).arg(JExpr.lit(5000));

      /* constructor, init the httpClient */
      JMethod constructor3 = constructor(JMod.PUBLIC);
      JBlock conBody3 = constructor3.body();

      conBody3.invoke("this").arg("localhost").arg(JExpr.lit(8081)).arg("folio_demo").arg("folio_demo").arg(JExpr.FALSE)
        .arg(JExpr.lit(2000)).arg(JExpr.lit(5000));
      constructor3.javadoc().add("Convenience constructor for tests ONLY!<br>Connect to localhost on 8081 as folio_demo tenant.");
