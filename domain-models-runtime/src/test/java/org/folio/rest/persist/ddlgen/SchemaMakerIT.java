...
public class SchemaMakerIT extends PostgresClientITBase {
  ...
  public void indexUpgrade(TestContext context) {
    ...
    assertThat(indexdef(context, "casetable_f_idx_ft"),     containsString("my_tsvector(f_unaccent((jsonb ->> 'f'::text)))"));
    ...
    assertThat(indexdef(context, "casetable_f_idx_ft"),     containsString("my_tsvector((jsonb ->> 'f'::text))"));
