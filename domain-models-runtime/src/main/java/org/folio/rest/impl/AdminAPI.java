...
public class AdminAPI implements AdminResource {
  ...
  public void postAdminUpload(MimeMultipart entity, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext)
    ...
    if (entity != null) {
      ...
      asyncResultHandler.handle(io.vertx.core.Future.succeededFuture(PostAdminUploadResponse.withPlainInternalServerError("ERROR uploading file, request was not valid - verify boundaries are identical")));
    }
