 ...
 * [RMB-733](https://issues.folio.org/browse/RMB-733) Upgrade to [Vert.x 3.9.3](https://vertx.io/blog/eclipse-vert-x-3-9-3-released/)
   Is a bug fix release of "stable" Vert.x.
 * [RMB-731](https://issues.folio.org/browse/RMB-731) Update to Okapi 4.1.3.
   Fixes an issue introduced in RMB 31.1.0. While not a bug in RMB as such,
   it fixes an issue with modules using both the Okapi (okapi-common
   presumably) and, obviously, RMB.
   See [MODUIMP-28](https://issues.folio.org/browse/MODUIMP-28)
