...
public class CompoundIndexTest {
  ...
  public void multiFieldNamesFT() throws Exception {
    ...
    String expected = "WHERE to_tsvector('simple', concat_space_sql(tablea.jsonb->>'field1' , tablea.jsonb->>'field2')) @@ tsquery_phrase('John Smith')";
    assertThat(sql, is(expected));
  }
  ...
  public void SQLExpressionFT() throws Exception {
    ...
    String expected = "WHERE to_tsvector('simple', lower(concat_space_sql(jsonb->>'field1', jsonb->>'field2'))) @@ tsquery_phrase('Boston MA')";
    assertThat(sql, is(expected));
  }
  ...
  public void SQLExpressionQueryFT() throws Exception {
    ...
    String expected = "WHERE to_tsvector('simple', reverse(jsonb->>'state')) @@ tsquery_phrase(reverse('MA'))";
    assertThat(sql, is(expected));
  }
  ...
  public void multiFieldnamesSpacesFT() throws Exception {
    ...
    String expected = "WHERE to_tsvector('simple', concat_space_sql(tablec.jsonb->>'firstName' , tablec.jsonb->>'lastName')) @@ tsquery_phrase('Boston MA')";
    assertThat(sql, is(expected));
  }
  ...
  public void multiFieldnamesMultipartFT() throws Exception {
    ...
    String expected = "WHERE to_tsvector('simple', concat_space_sql(tabled.jsonb->'proxy'->'personal'->>'city' , tabled.jsonb->'proxy'->'personal'->>'state')) @@ tsquery_phrase('Boston MA')";
    assertThat(sql, is(expected));
  }
  ...
  public void multiFieldnamesFTStar() throws Exception {
    ...
    String expected = "WHERE to_tsvector('simple', concat_space_sql(concat_array_object_values(tablea.jsonb->'field1','city') , concat_array_object_values(tablea.jsonb->'field2','state'))) @@ tsquery_phrase('Boston MA')";
    assertThat(sql, is(expected));
  }
  ...
  public void multiFieldnamesFTDotStar() throws Exception {
    ...
    String expected = "WHERE to_tsvector('simple', concat_space_sql(concat_array_object_values(tablea.jsonb->'field3'->'info','city') , concat_array_object_values(tablea.jsonb->'field3'->'info','state'))) @@ tsquery_phrase('Boston MA')";
    assertThat(sql, is(expected));
  }
  ...
  public void multiFieldnamesFTDotStarPlain() throws Exception {
    ...
    String expected = "WHERE to_tsvector('simple', concat_space_sql(concat_array_object(tablea.jsonb->'field3'->'info') , concat_array_object(tablea.jsonb->'field3'->'data'))) @@ tsquery_phrase('Boston MA')";
    assertThat(sql, is(expected));
  }
