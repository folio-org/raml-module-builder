...
* [RMB-609](https://issues.folio.org/browse/RMB-609) Upgrade to Vert.x 4:
  ...
  * In order to have structured logging for tests RMB based modules should copy [log4j2-test.properties](https://github.com/folio-org/raml-module-builder/blob/master/domain-models-runtime/src/test/resources/log4j2-test.properties) into their `/src/test/resources` directory
  * The responseHandler function in ClientGenerator should be migrated from Handler<HttpClientResponse> to Handler<AsyncResult<HttpResponse<Buffer>>>
